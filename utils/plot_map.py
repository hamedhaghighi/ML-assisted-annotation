...
with open(os.path.join('checkpoints', exp_name_1, 'random_val_avg_p_dict.pkl'), 'rb') as f:
    val_avg_p_dict_100 = pickle.load(f)
with open(os.path.join('checkpoints', exp_name_2, 'random_val_avg_p_dict.pkl'), 'rb') as f:
    val_avg_p_dict_500 = pickle.load(f)
with open(os.path.join('checkpoints', exp_name_3, 'random_val_avg_p_dict.pkl'), 'rb') as f:
