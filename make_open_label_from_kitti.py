...
# --- This script converts KITTI label files to OpenLabel format for use in annotation tools ---

# Set the data directory and get all label file paths
# This script converts KITTI label files to OpenLabel format
...
# --- Main conversion loop: iterate over all KITTI label files and convert to OpenLabel ---
frames = []
for ind, label_path in enumerate(label_list):
    ...
    attr_dict = {
        "text": [{"view": "Front"}],
        "boolean": [],
        "others": [{"score": 0}, {"bbox_id": 0}, {"person_id": 0}, {"lane_id": 0}],
    }
    objects = []
