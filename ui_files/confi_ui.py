...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../assets/config-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cvat_api_button.setText(_translate("Dialog", "CVAT.ai (API-based Ingegration)"))
